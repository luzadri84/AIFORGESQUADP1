...
Convención del proyecto, sin scheduler, agentes paralelos ni ejecución automática.
Estado único en [tasks.md](../specs/001-booking-espacios/tasks.md); leer AGENTS primero.

| Bloque | Contexto | Referencias |
|---|---|---|
| H001 | [Integrar Spec Kit y reconciliar la base](H001-integracion.md) | T001, T002 |
| H002 | [Preparar datos, contrato e identidad](H002-base-api.md) | T003, T004, T005 |
| H003 | [Completar el ciclo individual seguro](H003-reservas.md) | T006, T007 |
| H004 | [Conectar el primer recorrido de usuario](H004-frontend.md) | T008 |
